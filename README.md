...
<p align="center">
  <img src="https://cdn.dribbble.com/users/1708816/screenshots/15637256/media/f9826f0af8a49462f048262a8502035b.gif" width="40%" alt="Futuristic Dev Animation" />
</p>
...
- 🌟 Passionate about **Frontend Development**, **UI/UX**, and **Real-Time Applications**
- 🔍 Currently developing:  
  &nbsp;&nbsp;&nbsp;&nbsp;🔐 Facial Recognition Voting System  
  &nbsp;&nbsp;&nbsp;&nbsp;🛒 Mobile E-commerce App  
- 🧠 Focused on **AI integrations**, **Human-Centered Design**, and futuristic interfaces
...
|--------|------------|---------|
| 🔐 **Facial Recognition Voting** | React, Firebase, Face-API | Secure facial recognition authentication for elections |
| 🛒 **E-commerce App** | Flutter, Node.js, Firebase | Cross-platform store app with real-time backend |
| 🎨 **UX Case Studies** | Figma | High-fidelity designs with real-world interaction flow |

---

### 🧠 Fun Fact

> *"I build things for humans — intuitive, interactive, intelligent."*
